...
namespace Bt.IPay.Net.Responses.GetOrderStatusExtended
{
    public class GetOrderStatusExtendedResponse : ResponseBase
    {
        ...
        /// <summary>
        /// Starea comenzii. Valoarea este selectată dintre variantele enumerate mai jos. Absent,
        /// dacă nu a fost găsită nicio comandă potrivită.
        /// </summary>
        ...
        /// <summary>
        /// Identificator care este utilizat pentru o serie de plăți ulterioare care reapar până la sfârșitul
        /// perioadei de recurență. Leagă toate plățile ulterioare de plata inițială.
        /// </summary>
        ...
        /// <summary>
        /// include lista de elemente secureAuthInfo și atributele: pan, dată expirare, nume deținător de card
        /// și codul de aprobare:
        /// </summary>
